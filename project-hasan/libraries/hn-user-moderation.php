<?php
    ...
    */
    ...
    {
        if (($table = fopen("data/user_credentials.csv", "a")) == FALSE) return -1;
    ...
    {
        $updated_credential_list = file_get_contents("data/user_credentials.csv");
        $updated_credential_list = str_replace($credentials, "", $updated_credential_list);

        file_put_contents("data/user_credentials.csv", "");
        file_put_contents("data/user_credentials.csv", $updated_credential_list);
    ...
    {
        if (($table = fopen("data/user_rights.csv", "a")) == FALSE) return -1;
    ...
    {
        $updated_rights_list = file_get_contents("data/user_rights.csv");
        $updated_rights_list = str_replace($rights, "", $updated_rights_list);

        file_put_contents("data/user_rights.csv", "");
        file_put_contents("data/user_rights.csv", $updated_rights_list);
    ...
    */
    ...
    {
        if (($table = fopen("data/user_credentials.csv", "r")) == FALSE) return -1;
    ...
    {
        if (($table = fopen("data/user_credentials.csv", "r")) == FALSE) return "ERROR";
