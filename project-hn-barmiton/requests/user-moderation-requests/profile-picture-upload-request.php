<?php
    ...
    if(!isset($_FILES["profile-picture"]))
    {
        ...
        header("Location:../../content/user-modify-form.php?user_id=".$_SESSION["user_id"]."&upload-failed-image-not-found=1");
        exit;
    }
    ...
    if(!in_array($file_extension[1], $allowed_formats))
    {
        ...
        header("Location:../../content/user-modify-form.php?user_id=".$_SESSION["user_id"]."&upload-failed-format-not-supported=1");
        exit;
    }
    ...
    {
        echo "Unknown error";
        header("Location:../../content/user-modify-form.php?user_id=".$_SESSION["user_id"]."&upload-failed-unknown-error=1");
        exit;
    }
    ...
    {
        echo "File uploaded";
        header("Location:../../content/user-modify-form.php?user_id=".$_SESSION["user_id"]."&image-uploaded=1");
        exit;
    }
    else{
